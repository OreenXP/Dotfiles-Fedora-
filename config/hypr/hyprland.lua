...
-- Allow the requested fractional scale at 1920x1080.
hl.config({ debug = { disable_scale_checks = true } })

-- XWayland apps (e.g. ONLYOFFICE) render pixelated/blurry under fractional
-- scaling; disabling compositor upscaling keeps them crisp.
...
hl.animation({ leaf = "workspaces",    enabled = true,  speed = 7,    bezier = "smooth",       style = "slide" })
...
-- Move active window within the workspace with mainMod + SHIFT + arrow keys
...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("python3 ~/.config/hypr/scripts/level-osd.py volume up"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("python3 ~/.config/hypr/scripts/level-osd.py volume down"),      { locked = true, repeating = true })
hl.bind("XF86AudioMute",        hl.dsp.exec_cmd("python3 ~/.config/hypr/scripts/level-osd.py volume mute"),     { locked = true, repeating = true })
hl.bind("XF86AudioMicMute",     hl.dsp.exec_cmd("python3 ~/.config/hypr/scripts/level-osd.py microphone mute"), { locked = true, repeating = true })
hl.bind("XF86TouchpadToggle",   hl.dsp.exec_cmd("python3 ~/.config/hypr/scripts/touchpad-toggle.py toggle"), { locked = true })
hl.bind("XF86TouchpadOff",      hl.dsp.exec_cmd("python3 ~/.config/hypr/scripts/touchpad-toggle.py off"), { locked = true })
hl.bind("XF86TouchpadOn",       hl.dsp.exec_cmd("python3 ~/.config/hypr/scripts/touchpad-toggle.py on"), { locked = true })
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("python3 ~/.config/hypr/scripts/level-osd.py brightness up"),                  { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("python3 ~/.config/hypr/scripts/level-osd.py brightness down"),                  { locked = true, repeating = true })
